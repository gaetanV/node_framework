         ...
         constructor(port,host){     
             try{
                    ...
                    function route(){
                        ...
                        for (var i in doc) {
                                    if (!doc[i].hasOwnProperty("resource") || !doc[i].hasOwnProperty("prefix")) { throw "ERROR IN ROUTE";}
                                    ...
                                    for (var i in routes) {
                                        ...
                                        if (route.defaults.hasOwnProperty("_controller")) {
                                         ...
                                         var c = route.defaults._controller;
                                            ...
                                            if(!fn){throw "THE FUNCTION "+functionName+" DON'T EXISTE" }
                                            var $route=vm.use("/Component/Routing/route").inject(
                                                {
                                                    methods: route.methods.map(function (m) {return m.toUpperCase()}),
                                                    fn:fn,
