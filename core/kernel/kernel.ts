class kernel {
    ...
    constructor(
        ...
        try {
            ...
            injectable["inject"] = DependencyInjection;
            ...
            /* PARAMETERS */
            this.parameters = this.component("DependencyInjection/parameters")();
            ...
            injectable["parameters"] = this.parameters;
            ...
            if (framework.hasOwnProperty("compression_gzip")) {
                if (framework.compression_gzip === true) {
                    $app.use(this.injectable["compression"]({
            ...
            /* EVENT DISPATCHER */
            var $event = this.component("EventDispatcher/event")();
