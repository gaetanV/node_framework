(function () {
    ...
    function Security ( AUTH, ACCESS_CONTROL){ 
            ...
            for(var i in ACCESS_CONTROL){
                    ...
                    if(!access.hasOwnProperty("path")){throw "ERROR IN CONFIG ACCESS_CONTROL ATTRIBUT PATH IS NOT DEFINED"}
                    if (!access.hasOwnProperty("roles")) {throw "ERROR IN CONFIG ACCESS_CONTROL ATTRIBUT ROLES IS NOT DEFINED"} 
             }
            return {
                                       ...
                                       //TO DO DDOS
                                        ...
                                        if (access.hasOwnProperty("whiteip")) {
                                            ...
                                            for(var j in access.whiteip){
                                                if (access.whiteip[j] === ip) {inlist=true; break;}
                                            }
                                            if (!inlist) { throw "not allow your are not in white list"};
                                        }  
